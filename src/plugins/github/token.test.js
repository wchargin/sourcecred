...
import {validateToken, exampleGithubToken} from "./token";
...
describe("plugins/github/token", () => {
  ...
  it("has a dummy token which passes validation", () => {
    // Just sanity checking that it passed validation
    expect(validateToken(exampleGithubToken)).toEqual(exampleGithubToken);
  });
});
